...
download_dir = '/media/data3/nicway/GEM/continental/grib2_current'

# Dir where output netcdf files go
netcdf_dir  = '/media/data3/nicway/GEM/continental/netcdf_archive'

# Dir where output ascii files should go
ascii_dir    = '/media/data3/nicway/GEM/continental/CHM_Yukon'
...
# Yukon
lat_r = [59.788197,69.69858]
lon_r = [-141.63208,-123.55957]
