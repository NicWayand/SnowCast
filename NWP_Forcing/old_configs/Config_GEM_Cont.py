...
download_dir = '/media/data2/GEM/continental/grib2_current'

# Dir where output netcdf files go
netcdf_dir  = '/media/data2/GEM/continental/netcdf_archive'

# Dir where output ascii files should go
ascii_dir    = '/media/data2/GEM/continental/CHM_Yukon'
