...
netcdf_dir  = '/media/data3/nicway/GEM/early_HDRPS/netcdf'

# Dir where output ascii files should go
ascii_dir    = '/media/data3/nicway/GEM/early_HDRPS/ascii_chm_Snowcast'
...
Forcing_config_file = 'Lam_West_forcing.json'
